...
export const getUserInfo = async ({ userId }: getUserInfoProps) => {
   try {
     ...
     console.error("An error occurred while getting one user:", error);
   } 
}
...
export const getBank = async ({ documentId }: getBankProps) => {
  try {
    ...
    console.error("An error occurred while getting one bank account:", error);
  }
}
...
export const getBankByAccountId = async ({ accountId }: getBankByAccountIdProps) => {
  try {
    ...
    console.error("An error occurred while getting bank By accountId:", error);
  }
}